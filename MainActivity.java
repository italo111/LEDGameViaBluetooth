package com.example.ledpattern;
...
public class MainActivity extends AppCompatActivity {
    ...
    //1)
    Button pattern1,pattern2,pattern3,speed1,speed2,speed3;
    TextView IdBufferIn;
    //-------------------------------------------
    Handler bluetoothIn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speed1 = (Button) findViewById(R.id.speed1);
        speed2 = (Button) findViewById(R.id.speed2);
        speed3 = (Button) findViewById(R.id.speed3);
